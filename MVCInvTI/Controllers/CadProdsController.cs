...
namespace MVCInvTI.Controllers
{
    public class CadProdsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idProd,Maquina,Detalhes")] CadProd cadProd)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idProd,Maquina,Detalhes")] CadProd cadProd)
        {
