...
namespace MVCInvTI.Controllers
{
    public class CadClisController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            model.MaquinasList = _context.InvMaq.ToList();
            model.SoftwareList = _context.InvSoft.ToList();
            return View(model);
        }
        ...
        public async Task<IActionResult> Create([Bind("idCli,idMaq,idSoft,NomeCli,Telefone,CPF")] CadCli cadCli)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idCli,idMaq,idSoft,NomeCli,Telefone,CPF")] CadCli cadCli)
        {
            if (id != cadCli.idCli)
            {
                return NotFound();
