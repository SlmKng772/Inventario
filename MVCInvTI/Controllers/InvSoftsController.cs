...
namespace MVCInvTI.Controllers
{
    public class InvSoftsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idSoft,Software,CodSoft")] InvSoft invSoft)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idSoft,Software,CodSoft")] InvSoft invSoft)
        {
